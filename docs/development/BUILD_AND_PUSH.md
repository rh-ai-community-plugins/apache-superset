...
This produces a `apache-superset-chart-<version>.tgz` file in the current directory, using the version from `chart/Chart.yaml`.
...
helm push apache-superset-chart-<version>.tgz oci://quay.io/rh-ai-community-plugins
```
